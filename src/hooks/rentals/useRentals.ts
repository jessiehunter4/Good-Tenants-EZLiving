...
const LISTING_SELECT = `
  id, slug, display_address, neighborhood, rent, status, computed_status,
  bedrooms, bathrooms, sqft, property_type, year_built, lot_size,
  description, date_available, contract_status_change_date,
  ...
  open_house_allowed, suppressed_reason,
  rental_listing_photos ( photo_url, ordering )
`;
